...
<header>
      ...
      <div class="row gy-3">
        ...
        <div class="col-lg-2 col-sm-4 col-4">
          <a href="https://mdbootstrap.com/" target="_blank" class="float-start">
            <img class="w-8 h-8 mr-2" width="35" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/logo.svg" alt="logo">
        <p style="text-transform: none">NysOne</p>
        </a>
        </div>
        <!-- Left elements -->
  ...
  <div class="bg-primary mb-4">
    <div class="container py-4">
      <h3 class="text-white mt-2">Men,Women and Child's wear</h3>
      <!-- Breadcrumb -->
